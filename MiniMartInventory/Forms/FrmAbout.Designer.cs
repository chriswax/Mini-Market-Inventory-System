namespace MiniMartInventory
{
	partial class FrmAbout
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelProductName.Text = "Mini-Mart Inventory System";
			...
			this.labelCompanyName.Text = "Citechs Solution";
			...
			this.textBoxDescription.Text = "Mini Mart Inventory is an Inventory Management System developed using C# and foll" +
    "owing all the security best practices. ";
			// 
			// okButton
			// 
